...
// Server implements the AnchorService gRPC server.
type Server struct {
	anchorv1.UnimplementedAnchorServiceServer
	svc *service.AnchorService
}

// NewServer creates a new gRPC server for the anchor service.
func NewServer(svc *service.AnchorService) *Server {
